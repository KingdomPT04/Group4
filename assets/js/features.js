    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">Group</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal) {
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">Group4</span> <span class="clr-green md">Canteen</span></div>
            <div><i onclick="signUpModal.classList.remove('show');" class="fas fa-times"></i></div>
        </div>
        <!-- Other way of LogIn's -->
        <ul class="modal-icons flex">
                <li><button><i class="fab fa-google" id="#"></i></button></li>
                <li><button><i class="fab fa-github" id="#"></i></button></li>
                <li><button><i class="fab fa-facebook" id="#"></i></button></li>
        </ul>
        <!-- Sign Up Input's -->
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="#" target="_blank">MIT Indore</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
